    ...
    $(".btn-save-config").on("click", function(){
        ...
        if ($('[instance-data-id]').length > 0) {
            ...
            if (changed_primary.length > 0) {
                changeTesterHandler(changed_primary, user_details, server); //TURNED OFF EMAIL NOTIFICATION API - NEED TO FIX SERVER OR FIREWALL ISSUE
    ...
    $(".btn-hw-process").on("click", function(){
        ...
        switch ($(this).attr("process-type")) {
            case "expedite":
                ...
                msg = "Make sure that you have a go signal from the Hardware team before executing this process.";
            ...
            default:
                ...
                msg = "This will delete the Pending Hardware Change for this Part Number.";
...
function changeTesterHandler(payload, user_details, server){
    ...
    // switch (server) {
    //     case "LOCAL":
    //         url = "../page-sections/emails/HW-HANDSHAKE-PROCESS.PHP";
    //         break;
    //     case "TEST":
    //         url = "../../TEST/BRAIN_UI_JCDP/page-sections/emails/HW-HANDSHAKE-PROCESS.PHP";
    //         break;
    //     default:
    //         url = "../../API/BRAIN_UI_JCDP/page-sections/emails/HW-HANDSHAKE-PROCESS.PH";
    //         break;
    // }
    $.ajax({
        type: 'post',
        ...
        if ($.inArray(hw_set_id, hw_sets) !== -1) {
            sets += '<div class="col-lg-3">'+
                '<div class="card">'+
                    ...
                    '<div class="card-body">'+
                        '<table class="table table-bordered table-hover"><thead><tr><th>HW_TYPE</th><th>HW_NAME</th></tr></thead>'+
                    ...
                    '<div class="card-footer d-flex justify-content-center pr-2">'+
                        '<div class="form-check">'+
                            ...
                            'setup-group="'+d[15]+'"'+
                            'id="hardware_radio_'+identifier+'" '+selected+'>'+
...
function resetPrimarySetup(all_original_primary, all_original_alternate){
    ...
    console.log(all_original_primary);
    console.log(all_original_alternate);
